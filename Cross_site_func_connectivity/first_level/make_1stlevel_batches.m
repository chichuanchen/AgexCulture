...
PATH_FC_1st = ['/home/.bml/Data/Bank1/Age_Culture/Calibration/f_connectivity/first_level/derivatives/'];
...
save(['fc_firstlevel_' site '_' num2str(subj) '_' num2str(sess) '.mat'], 'matlabbatch')
